...
// Research constraint note: this session could reach sources only via web-search summaries
// (direct fetch of most portals was blocked). Where a state-level figure could not be
// verified, the entry says so explicitly and confidence is lowered. No numbers invented.
...
window.INDIA_DATA_PARTS["soil-a"] = {
  states: {
    ...
    "andaman-nicobar": {
      ...
      districtHighlights: [
        { district: "South Andaman", note: "Most populous district; UT soil data on the SHC portal aggregates a small sample base" },
        { district: "North & Middle Andaman", note: "Main farming belt of the Andaman group; district-level soil figures not verified in this compilation" },
        { district: "Nicobar", note: "Remote island district with minimal published soil-testing data" }
      ],
      facts: [
      ...
      sources: [
        ...
        { title: "Soil Health Card — Factsheet", publisher: "Press Information Bureau, GoI", url: "https://www.pib.gov.in/FactsheetDetails.aspx?Id=148602&reg=48&lang=2", year: 2024 },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 }
      ],
      confidence: "low",
      media: []
    },
    ...
    "andhra-pradesh": {
      ...
      districtHighlights: [
        { district: "Nellore (Sri Potti Sriramulu Nellore)", note: "Red and associated soils studied under the Somasila project: Zn sufficient at surface but deficient in sub-surface horizons; available Fe deficient" },
        { district: "Chittoor", note: "Sugarcane-belt soils were the subject of a dedicated nutrient-status study (AGRIS-indexed)" },
        { district: "Anantapur", note: "Semi-arid dryland district in the tract where ICRISAT documents widespread sulphur, boron and zinc deficiency" }
      ],
      facts: [
      ...
      sources: [
        ...
        { title: "Soil Fertility Status in Tatrakallu Village of Andhra Pradesh", publisher: "Int. J. Current Microbiology & Applied Sciences", url: "https://www.ijcmas.com/8-6-2019/G.%20Sashikala,%20et%20al.pdf", year: 2019 },
        ...
        { title: "Nutrient status of some red and associated soils of Nellore district under Somasila project", publisher: "AGRIS / FAO index", url: "https://agris.fao.org/search/en/providers/122648/records/6471f55877fd37171a71d050" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "arunachal-pradesh": {
      ...
      districtHighlights: [
        { district: "East Siang", note: "Pasighat area — Siang river valley alluvial terraces form one of the state's main settled-farming belts" },
        { district: "Lower Subansiri", note: "Ziro valley's terraced wet-rice system is a long-standing indigenous soil-fertility management landscape" },
        { district: "Papum Pare", note: "Capital-region district; settled valley agriculture alongside shifting cultivation on slopes" }
      ],
      facts: [
    ...
    "assam": {
      ...
      districtHighlights: [
        ...
        { district: "Dhubri", note: "Brahmaputra riverine soils analysed for physico-chemical parameters; lies in the Lower Brahmaputra Valley Zone, the zone with the highest boron deficiency (~36%)" },
        { district: "Kamrup", note: "Also in the Lower Brahmaputra Valley Zone flagged for the state's highest zone-level boron deficiency" },
        { district: "Dibrugarh", note: "Upper Brahmaputra Valley Zone, where surveyed boron deficiency was lowest (~28%)" }
      ],
      facts: [
      ...
      sources: [
        { title: "To study the availability of boron status under different agro-climatic zones in soils of Assam", publisher: "Assam Agricultural University (via Academia.edu)", url: "https://www.academia.edu/91129446/To_study_the_availability_of_boron_status_under_different_agro_climatic_zone_in_soils_of_Assam" },
        { title: "Physico-chemical properties and acidity components of some alluvial derived soils of the Brahmaputra valley of Assam", publisher: "Academia.edu (journal reprint)", url: "https://www.academia.edu/85321646/Physico_chemical_properties_and_acidity_components_of_some_alluvial_derived_soils_of_the_Brahmaputra_valley_of_Assam" },
        { title: "Boron in Soil Plant System and Its Significance in Indian Agriculture", publisher: "Academia.edu (review reprint)", url: "https://www.academia.edu/122923541/Boron_in_Soil_Plant_System_and_Its_Significance_in_Indian_Agriculture" },
        { title: "Soil Health Card — Directorate of Agriculture, Assam", publisher: "Government of Assam", url: "https://diragri.assam.gov.in/portlet-innerpage/soil-health-card" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "bihar": {
      ...
      districtHighlights: [
        { district: "Muzaffarpur", note: "Kurhani block was the subject of a dedicated soil-fertility-status study; lies in the calcareous north Bihar plain" },
        { district: "Samastipur", note: "Village-level micronutrient studies in rice-growing villages; home district of Dr. Rajendra Prasad Central Agricultural University (Pusa)" },
        { district: "Patna", note: "South-bank district including tal (seasonal deep-flood) lands with distinct nutrient dynamics" }
      ],
      facts: [
      ...
      sources: [
        ...
        { title: "Micronutrient Deficiencies in Crops and Soils in India", publisher: "Springer (book chapter)", url: "https://link.springer.com/chapter/10.1007/978-1-4020-6860-7_4", year: 2008 },
        { title: "Soil fertility status in Kurhani block of Muzaffarpur district of Bihar", publisher: "Journal reprint (ResearchGate)", url: "https://www.researchgate.net/publication/289242131_Soil_fertility_status_in_Kurhani_block_of_Muzaffarpur_district_of_Bihar" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "chandigarh": {
      ...
      districtHighlights: [
        { district: "Chandigarh", note: "The UT's only district; farmland is a small peri-urban fringe of the planned city" }
      ],
      facts: [
    ...
    "chhattisgarh": {
      ...
      districtHighlights: [
        { district: "Kabeerdham (Kawardha)", note: "Vertisol survey found 99.1% of soil samples low in available nitrogen" },
        { district: "Baloda Bazar-Bhatapara", note: "Palari block survey: 45.56% of samples deficient in available zinc; Kasdol block boron sufficient to high" },
        ...
        { district: "Bilaspur", note: "Listed among the principal red-yellow soil districts of the state" }
      ],
      facts: [
      ...
      sources: [
        { title: "Evaluations of soil fertility status of available major nutrients (N, P, K) and micronutrients in Vertisol of Kabeerdham district of Chhattisgarh", publisher: "Academia.edu (journal reprint)", url: "https://www.academia.edu/94590210/Evaluations_of_soil_Fertility_Status_of_Available_Major_Nutrients_N_P_and_K_and_Micro_Nutrients_Fe_Mn_Cu_and_Zn_in_Vertisol_of_Kabeerdham_District_of_Chhat_tisgarh_India" },
        { title: "Evaluation of available zinc status in the soils of Kasdol/Palari blocks, Baloda Bazar", publisher: "International Journal of Chemical Studies", url: "https://www.chemijournal.com/archives/2017/vol5issue5/PartB/5-4-393-740.pdf", year: 2017 },
        { title: "Soil in Chhattisgarh (IGKV Raipur teaching presentation)", publisher: "IGKV Raipur (via SlideShare)", url: "https://www.slideshare.net/slideshow/soil-in-chhattisgarh-igkv-raipur-cg/248331374" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "dadra-nagar-haveli-daman-diu": {
      ...
      districtHighlights: [
        { district: "Dadra & Nagar Haveli", note: "Hilly, high-rainfall interior district with the UT's main farm area" },
        { district: "Daman", note: "Coastal enclave district on the Daman Ganga estuary" },
    ...
    "delhi": {
      ...
      districtHighlights: [
        { district: "South West Delhi", note: "District administration runs a Soil Health Card scheme page; contains one of the NCT's main remaining rural belts (Najafgarh side)" },
        { district: "North West Delhi", note: "The other principal rural-fringe district of the NCT" },
        { district: "Central North Delhi area (district administration)", note: "Also administers the SHC scheme per its official scheme page" }
      ],
      facts: [
      ...
      sources: [
        ...
        { title: "Soil Health Card scheme — District Central North", publisher: "Government of NCT of Delhi", url: "https://dmcentralnorth.delhi.gov.in/scheme/soil-health-card/" },
    ...
    "goa": {
      ...
      districtHighlights: [
        { district: "North Goa", note: "Contains extensive khazan lowlands along the Mandovi estuary and ICAR-CCARI at Old Goa" },
        { district: "South Goa", note: "Lateritic uplands with plantation agriculture and khazans along the Zuari" }
      ],
      facts: [
    ...
    "gujarat": {
      ...
      districtHighlights: [
        { district: "Vadodara", note: "Highest surveyed sulphur deficiency among the central-Gujarat districts: 68.4% of samples" },
        { district: "Kheda", note: "61.2% of samples sulphur-deficient in the consulted survey" },
        ...
        { district: "Gandhinagar", note: "79.38% of samples low in available N, 71.88% medium in P, 50% high in K, 48.75% high in S (160-sample district study)" }
      ],
      facts: [
      ...
      sources: [
        ...
        { title: "Fertility status of cultivated soils in coastal Bhavnagar district of Saurashtra region of Gujarat", publisher: "Journal reprint (ResearchGate)", url: "https://www.researchgate.net/publication/282820141_Fertility_status_of_cultivated_soils_in_coastal_bhavnagar_district_of_saurashtra_region_of_Gujarat", year: 2015 }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "haryana": {
      ...
      districtHighlights: [
        ...
        { district: "Hisar", note: "Seat of CCS Haryana Agricultural University; sandy-loam soils flagged as lacking N, phosphate and zinc" },
        { district: "Bhiwani", note: "Sandy southwestern district among those flagged for N, phosphate and zinc shortage" }
      ],
      facts: [
      ...
      sources: [
        { title: "Haryana varsity study finds widespread nutrient depletion threatening crop yields and food security", publisher: "ETV Bharat (reporting CCS HAU study)", url: "https://www.etvbharat.com/en/bharat/haryana-varsity-study-finds-widespread-nutrient-depletion-threatening-crop-yields-and-food-security-enn25121403086", year: 2025 },
        { title: "Status of Micronutrient Deficiencies in Soils of Haryana", publisher: "ICAR-Indian Institute of Soil Science", url: "https://iiss.res.in/downloads/division/Status%20of%20Micronutrients%20Deficiencies%20in%20Soils%20of%20Haryana.pdf" },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 }
      ],
      confidence: "high",
      media: []
