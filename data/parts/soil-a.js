// data/parts/soil-a.js — Soil Health (part A: 12 states/UTs, andaman-nicobar ... haryana)
// Compiled from internet research on 2026-08-08. Every numeric fact is tied to a consulted source.
// Research constraint: this session could reach most portals only via web-search result content
// (direct fetch of nearly all publisher and gov domains was blocked by the egress proxy).
...
// Key bulk sources consulted: ICAR-AICRP micronutrient survey (Shukla & Behera et al., Scientific
// Reports 11:19760, 2021 — 2,42,827 samples, 615 districts, 28 states; all-India deficiency
// S 58.6%, Zn 51.2%, B 44.7%, Fe 19.2%, Cu 11.4%, Mn 17.4%), Soil Health Card scheme data
// (>25 crore cards distributed as of July 2025; CSE/Down To Earth analyses of SHC samples),
// ICAR-IISS state reports, and state agricultural university surveys.
window.INDIA_DATA_PARTS = window.INDIA_DATA_PARTS || {};
window.INDIA_DATA_PARTS["soil-a"] = {
  states: {
    ...
    "andaman-nicobar": {
      ...
      districtHighlights: [
        { district: "South Andaman", note: "Seat of ICAR-CIARI (Port Blair), the islands' agricultural and soil research institute" },
        { district: "North & Middle Andaman", note: "Main farming belt of the Andaman group; acidic upland and valley soils" },
        { district: "Nicobar", note: "Remote island district with minimal published soil-testing data; coconut-dominated coastal soils" }
      ],
      facts: [
      ...
      sources: [
        { title: "Andaman and Nicobar Islands — state profile", publisher: "Indian Council of Agricultural Research", url: "https://icar.org.in/en/node/17297" },
        { title: "How nutrient-deficient are Indian soils? (SHC 2015-19 analysis)", publisher: "Down To Earth", url: "https://www.downtoearth.org.in/agriculture/how-nutrient-deficient-are-indian-soils--82732" },
        { title: "Application of RMMF-Based GIS Model for Soil Erosion Assessment in Andaman Ecosystem", publisher: "Land (MDPI)", url: "https://www.mdpi.com/2073-445X/12/5/1083", year: 2023 },
        { title: "Soil Health Card portal (state/UT dashboards)", publisher: "Dept. of Agriculture & Farmers Welfare, GoI", url: "https://soilhealth.dac.gov.in/" }
      ],
      confidence: "low",
      media: []
    },
    ...
    "andhra-pradesh": {
      ...
      districtHighlights: [
        { district: "Anantapur", note: "Semi-arid Rayalaseema dryland district in the tract where ICRISAT documents widespread S, B and Zn deficiency" },
        { district: "Sri Potti Sriramulu Nellore", note: "Red and associated soils studied under the Somasila project; zinc and iron constraints reported in profile studies" },
        { district: "East Godavari", note: "Godavari delta alluvium — part of the state's most fertile soil tract" },
        { district: "Guntur", note: "Krishna delta and black-soil belt; intensive chilli-cotton cropping on Vertisol-type soils" }
      ],
      facts: [
      ...
      sources: [
        ...
        { title: "Widespread deficiencies of sulphur, boron and zinc in dryland soils of the Indian semi-arid tropics", publisher: "ICRISAT (OAR repository)", url: "https://oar.icrisat.org/2471/" },
        { title: "Designing better input support programs: Lessons from zinc subsidies in Andhra Pradesh, India", publisher: "PLoS ONE (via PubMed Central)", url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7714421/", year: 2020 },
        { title: "Soils of Andhra Pradesh", publisher: "Andhra Pradesh PSC Exam Notes (soil-group shares)", url: "https://andhrapradesh.pscnotes.com/andhra-general-studies/soils-of-andhra-pradesh/" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "arunachal-pradesh": {
      ...
      districtHighlights: [
        { district: "East Siang", note: "Pasighat area — Siang valley terraces; subject of a dedicated agricultural-landscape soil study" },
        { district: "Lower Subansiri", note: "Ziro valley's terraced wet-rice system, a long-standing indigenous soil-fertility management landscape" },
        { district: "Papum Pare", note: "Capital-region district mixing settled valley agriculture with jhum on slopes" }
      ],
      facts: [
      ...
      sources: [
        { title: "Arunachal Pradesh — state profile", publisher: "Indian Council of Agricultural Research", url: "https://icar.org.in/en/node/17258" },
        { title: "Soil physico-chemical properties under four agroecosystems in Arunachal Pradesh, Eastern Himalaya", publisher: "Journal reprint (ResearchGate)", url: "https://www.researchgate.net/publication/286559928_Soil_physico-chemical_properties_under_four_agroecosystems_in_Arunachal_Pradesh_Eastern_Himalaya" },
        { title: "Dynamics of soil organic carbon of jhum agriculture land-use system in the heterogeneous hill of Arunachal Pradesh, India", publisher: "Scientific Reports (Nature)", url: "https://www.nature.com/articles/s41598-023-38421-1", year: 2023 }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "assam": {
      ...
      districtHighlights: [
        { district: "Dibrugarh", note: "Upper Brahmaputra Valley Zone — highest organic carbon and available N, and the lowest zone-level boron deficiency (about 28%)" },
        { district: "Kamrup", note: "Lower Brahmaputra Valley Zone, the zone with the state's highest surveyed boron deficiency (about 36%)" },
        { district: "Morigaon", note: "Subject of a dedicated study on boron availability under different cropping systems" },
        { district: "Dhemaji", note: "Jiyadhol river-basin landform study assessed soil fertility of this flood-prone district" }
      ],
      facts: [
      ...
      sources: [
        { title: "To study the availability of boron status under different agro-climatic zones in soils of Assam", publisher: "Assam Agricultural University (journal reprint)", url: "https://www.academia.edu/91129446/To_study_the_availability_of_boron_status_under_different_agro_climatic_zone_in_soils_of_Assam" },
        { title: "Boron in Soil Plant System and Its Significance in Indian Agriculture", publisher: "Ecology, Environment and Conservation (review)", url: "https://www.envirobiotechjournals.com/EEC/vol28issue2/EEC-57.pdf" },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS AICRP", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 },
        { title: "Fertility capability classification (FCC) of soils of a lower Brahmaputra valley area of Assam", publisher: "Journal reprint (Academia.edu)", url: "https://www.academia.edu/129774263/Fertility_capability_classification_FCC_of_soils_of_a_lower_Brahmaputra_valley_area_of_Assam_India" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "bihar": {
      ...
      districtHighlights: [
        { district: "Muzaffarpur", note: "GPS/GIS soil-fertility mapping found available N and P very low — N about 90% deficient in some blocks" },
        { district: "Samastipur", note: "Home of RPCAU Pusa, whose calcareous experimental soils (running trials since 1985) are inherently deficient in zinc and sulphur" },
        { district: "Patna", note: "With Vaishali and Saran, subject of a spatial-variability study of soil chemical properties along the Ganga; includes tal seasonal-flood lands" },
        { district: "Vaishali", note: "Ganga-adjoining district in the same spatial-variability study; calcareous alluvial plain" }
      ],
      facts: [
      ...
      sources: [
        { title: "Soil zinc surveillance frameworks can inform human nutrition studies: opportunities in India", publisher: "Frontiers in Soil Science (Rothamsted/NERC co-authored)", url: "https://www.frontiersin.org/journals/soil-science/articles/10.3389/fsoil.2024.1421652/full", year: 2024 },
        { title: "Geospatial Analysis of Soil Fertility in Muzaffarpur District, Bihar, India", publisher: "SSRN / journal preprint", url: "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4879093", year: 2024 },
        { title: "Long-Term Zinc Fertilization in Calcareous Soils Improves Wheat Productivity and Soil Zinc Status in the Rice-Wheat Cropping System (RPCAU Pusa)", publisher: "Agronomy (MDPI)", url: "https://www.mdpi.com/2073-4395/11/7/1306", year: 2021 },
        { title: "Spatial Variability of Soil Chemical Properties in Patna, Vaishali and Saran Districts Adjoining the Ganga River, Bihar", publisher: "International Journal of Bio-resource and Stress Management", url: "https://ojs.pphouse.org/index.php/IJBSM/article/view/4212", year: 2022 }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "chandigarh": {
      ...
      districtHighlights: [
        { district: "Chandigarh", note: "The UT's only district; farmland is a small peri-urban fringe of the planned city on Shivalik-piedmont alluvium" }
      ],
      facts: [
      ...
      sources: [
        { title: "Soil Health Card portal (state/UT dashboards)", publisher: "Dept. of Agriculture & Farmers Welfare, GoI", url: "https://soilhealth.dac.gov.in/" },
        { title: "Soil Health Card — 'Swasth Dharaa, Khet Haraa' factsheet", publisher: "Press Information Bureau, GoI", url: "https://static.pib.gov.in/WriteReadData/specificdocs/documents/2025/aug/doc2025816613501.pdf", year: 2025 }
      ],
      confidence: "low",
      media: []
    },
    ...
    "chhattisgarh": {
      ...
      districtHighlights: [
        { district: "Kabeerdham (Kawardha)", note: "297-sample Vertisol survey: 99.1% low N, 87% low P, 88.9% high K; Zn and Fe inadequate in large parts" },
        { district: "Baloda Bazar-Bhatapara", note: "Palari block survey: 45.56% of samples zinc-deficient, but only 0.10% manganese-deficient" },
        { district: "Raipur", note: "Seat of Indira Gandhi Krishi Vishwavidyalaya (IGKV), the state's soil-research hub, in the red-yellow soil rice belt" },
        { district: "Bilaspur", note: "Among the principal red-yellow soil districts (with Mahasamund, Korba, Durg and Jashpur)" }
      ],
      facts: [
      ...
      sources: [
        { title: "Evaluations of soil fertility status of available major nutrients (N, P, K) and micronutrients in Vertisol of Kabeerdham district of Chhattisgarh", publisher: "Journal reprint (IJIMS/Academia.edu)", url: "https://www.ijims.com/uploads/8ae6072f8d73f2d1acb7OC13.pdf" },
        { title: "Evaluation of available zinc status in the soils of Kasdol and Palari blocks, Baloda Bazar district", publisher: "International Journal of Chemical Studies", url: "https://www.chemijournal.com/archives/2017/vol5issue5/PartB/5-4-393-740.pdf", year: 2017 },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS AICRP", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 },
        { title: "Different Types of Soil Found in Chhattisgarh", publisher: "Testbook (Chhattisgarh GK, citing state soil classification)", url: "https://testbook.com/chhattisgarh-gk/types-of-soil-in-chhattisgarh" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "dadra-nagar-haveli-daman-diu": {
      ...
      districtHighlights: [
        { district: "Dadra & Nagar Haveli", note: "Hilly, high-rainfall interior district with the UT's main farm area on lateritic soils" },
        { district: "Daman", note: "Coastal enclave district on the Daman Ganga estuary with alluvial pockets" },
        { district: "Diu", note: "Small island/coastal district off Saurashtra with sandy coastal soils" }
      ],
      facts: [
      ...
      sources: [
        { title: "Soil Health Card portal (state/UT dashboards)", publisher: "Dept. of Agriculture & Farmers Welfare, GoI", url: "https://soilhealth.dac.gov.in/" },
        { title: "8 Major Types of Soil in India and Their Characteristics (laterite distribution incl. DNH, Daman & Diu)", publisher: "Earth Reminder (geography reference)", url: "https://www.earthreminder.com/types-of-soil-in-india/" },
        { title: "Agriculture Department, Daman", publisher: "U.T. Administration of Dadra & Nagar Haveli and Daman & Diu", url: "http://daman.nic.in/agriculture.aspx" }
      ],
      confidence: "low",
      media: []
    },
    ...
    "delhi": {
      ...
      districtHighlights: [
        { district: "South West Delhi", note: "District administration runs an official SHC scheme page; contains the Najafgarh-side rural belt" },
        { district: "North West Delhi", note: "The other principal rural-fringe district; also runs an official SHC scheme page" },
        { district: "Shahdara", note: "East-of-Yamuna district with an official SHC scheme page covering its khadar fringe" }
      ],
      facts: [
      ...
      sources: [
        { title: "Soil Health Card scheme — District South West", publisher: "Government of NCT of Delhi", url: "https://dmsouthwest.delhi.gov.in/scheme/soil-health-card/" },
        { title: "Soil Health Card scheme — District Shahdara", publisher: "Government of NCT of Delhi", url: "https://dmshahdara.delhi.gov.in/scheme/soil-health-card/" },
        { title: "Khadar — alluvial soil (definition)", publisher: "Encyclopaedia Britannica", url: "https://www.britannica.com/science/khadar" },
        { title: "Soil Health Card portal", publisher: "Dept. of Agriculture & Farmers Welfare, GoI", url: "https://soilhealth.dac.gov.in/" }
      ],
      confidence: "low",
      media: []
    },
    ...
    "goa": {
      ...
      districtHighlights: [
        { district: "North Goa", note: "Khazan lowlands along the Mandovi estuary; ICAR-CCARI is at Old Goa in this district" },
        { district: "South Goa", note: "Site of the 258-sample geo-referenced khazan fertility survey; lateritic uplands with plantation agriculture" }
      ],
      facts: [
      ...
      sources: [
        { title: "Geospatial Mapping of Soil Properties of Forest Types ... to Delineate Site-Specific Nutrient Management Zones in Goa", publisher: "Journal of the Indian Society of Remote Sensing (Springer) / ICAR-CCARI", url: "https://link.springer.com/article/10.1007/s12524-024-02082-y", year: 2024 },
        { title: "Fertility Status of the Unique Coastal Acid Saline Soils of Goa", publisher: "Journal of the Indian Society of Soil Science", url: "https://indianjournals.com/article/jisss-63-2-014", year: 2015 },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS AICRP", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 },
        { title: "'Despite challenges, Goa's forest soil fertility is good' (CCARI study report)", publisher: "The Navhind Times", url: "https://navhindtimes.in/goanews/despite-challenges-goas-forest-soil-fertility-is-good/" }
      ],
      confidence: "medium",
      media: []
    },
    ...
    "gujarat": {
      ...
      districtHighlights: [
        { district: "Vadodara", note: "Highest surveyed sulphur deficiency among middle-Gujarat districts: 68.4% of samples" },
        { district: "Kheda", note: "61.2% of samples sulphur-deficient in the 1,674-sample middle-Gujarat survey" },
        { district: "Anand", note: "53.4% sulphur-deficient; headquarters of Anand Agricultural University, source of much of the state's soil research" },
        { district: "Panchmahals", note: "52.2% of samples sulphur-deficient" },
        { district: "Gandhinagar", note: "160-sample district study: 79.38% low in N, 71.88% medium in P, 50% high in K, 48.75% high in S; pH 7.94, OC 0.38%" }
      ],
      facts: [
      ...
      sources: [
        { title: "Emergence of sulphur deficiency in soils of Kheda, Anand, Vadodara and Panchamahals districts of middle Gujarat", publisher: "African Journal of Agricultural Research (Academic Journals)", url: "https://academicjournals.org/journal/AJAR/article-in-press-abstract/emergence_of_sulphur_deficiency_in_soils_of_kheda_anand_vadodara_and_panchamahals_districts_of_middle_gujarat_india" },
        { title: "Status of available major nutrients in soils of Gandhinagar district of Gujarat", publisher: "Journal reprint (ResearchGate)", url: "https://www.researchgate.net/publication/329706612_Status_of_available_major_nutrients_in_soils_of_Gandhi_nagar_district_of_Gujarat", year: 2018 },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS AICRP", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 },
        { title: "Status of Sulphur and Boron in Soils of North Gujarat Region of India", publisher: "Journal reprint (ResearchGate)", url: "https://www.researchgate.net/publication/355268847_Status_of_Sulphur_and_Boron_in_Soils_of_North_Gujarat_Region_of_India", year: 2021 }
      ],
      confidence: "high",
      media: []
    },
    ...
    "haryana": {
      ...
      districtHighlights: [
        { district: "Mahendragarh", note: "State's highest surveyed sulphur (27.8%) and zinc (14.5%) deficiency in the CCS HAU 22-district study" },
        { district: "Fatehabad", note: "Highest surveyed iron (14.8%) and copper (4.9%) deficiency in the same study" },
        { district: "Hisar", note: "Seat of CCS Haryana Agricultural University, which ran the 2025 statewide soil survey" },
        { district: "Karnal", note: "Home of ICAR-Central Soil Salinity Research Institute, the national hub for saline-sodic soil reclamation" }
      ],
      facts: [
      ...
      sources: [
        { title: "Haryana varsity study finds widespread nutrient depletion threatening crop yields and food security", publisher: "ETV Bharat (reporting the CCS HAU study)", url: "https://www.etvbharat.com/en/bharat/haryana-varsity-study-finds-widespread-nutrient-depletion-threatening-crop-yields-and-food-security-enn25121403086", year: 2025 },
        { title: "Status of Micronutrient Deficiencies in Soils of Haryana", publisher: "ICAR-Indian Institute of Soil Science", url: "https://iiss.icar.gov.in/downloads/Status%20of%20Micronutrients%20Deficiencies%20in%20Soils%20of%20Haryana.pdf" },
        { title: "Deficiency of phyto-available sulphur, zinc, boron, iron, copper and manganese in soils of India", publisher: "Scientific Reports (Nature) / ICAR-IISS AICRP", url: "https://www.nature.com/articles/s41598-021-99040-2", year: 2021 },
        { title: "How nutrient-deficient are Indian soils? (SHC 2015-19 analysis)", publisher: "Down To Earth", url: "https://www.downtoearth.org.in/agriculture/how-nutrient-deficient-are-indian-soils--82732" }
      ],
      confidence: "high",
