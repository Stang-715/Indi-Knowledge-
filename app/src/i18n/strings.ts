...
const en: Dict = {
  ...
  'fig.age': '{n} days old',
  'fig.sample': 'Sample figure — not from the source named',
  'fig.stale': 'Older than this kind of figure stays useful',

  'bharat.title': 'Bharat',
  'bharat.tagline': 'History, live data and trade — and your shop on a map everybody can see.',
  'bharat.section.state': 'State',
  'bharat.section.data': 'Live data',
  'bharat.section.trade': 'Trade',
  'bharat.section.directory': 'Directory',
  'bharat.section.stores': 'Shops',
  'bharat.pick': 'Choose a state',
  'bharat.pickHint': 'Everything below is scoped to it.',
  'bharat.sources': 'Every source on this page',
  'bharat.sourcesBody':
    'One list, so the provenance of the whole page can be read at once rather than figure by figure.',

  'state.formed': 'Formed',
  'state.capital': 'Capital',
  'state.districts': 'Districts',
  'state.lok': 'Lok Sabha seats',
  'state.assembly': 'Assembly seats',
  'state.languages': 'Languages',
  'state.timeline': 'What happened here',

  'wx.title': 'Weather',
  'wx.none': 'No station is reporting for this state.',
  'wx.temp': 'Temperature',
  'wx.rain': 'Rain, last 24 hours',
  'wx.humidity': 'Humidity',
  'wx.advisories': 'What it means',
  'wx.kind.sowing': 'Sowing',
  'wx.kind.transport': 'Transport',
  'wx.kind.heat': 'Heat',
  'wx.kind.flood': 'Flood',

  'trade.title': 'Agriculture and export',
  'trade.none': 'No commodity flows are recorded for this state.',
  'trade.volume': 'Volume',
  'trade.value': 'Value',
  'trade.yoy': 'Against last year',
  'trade.destinations': 'Where it goes',
  'trade.ports': 'Port throughput',
  'trade.containers': 'Containers',
  'trade.cargo': 'Cargo',
  'trade.period': 'Period',

  'dir.title': 'Export houses and electric vehicles',
  'dir.none': 'Nothing is listed for this state yet.',
  'dir.all': 'All',
  'dir.sector.export-house': 'Export houses',
  'dir.sector.electric-vehicle': 'Electric vehicles',
  'dir.sector.battery': 'Batteries',
  'dir.sector.components': 'Components',
  'dir.since': 'Trading since {y}',

  'shop.title': 'Shops',
  'shop.tagline': 'Listed by the people who run them. The map shows shops, never shoppers.',
  'shop.search': 'Find a shop',
  'shop.none': 'No shop matches that.',
  'shop.open': 'List your shop',
  'shop.name': 'Name of the shop',
  'shop.category': 'What kind of shop',
  'shop.address': 'Address',
  'shop.addressHint':
    'The address of the business, as you would write it on a sign. Nothing about where you are is read.',
  'shop.what': 'What you sell',
  'shop.hours': 'Opening hours',
  'shop.phone': 'Phone (optional)',
  'shop.locality': 'Locality',
  'shop.publish': 'Publish the listing',
  'shop.publishing': 'Publishing…',
  'shop.published': 'Listed. It is on the map now, marked unverified.',
  'shop.failed': 'It could not be listed. Nothing was sent twice.',
  'shop.unverified': 'Unverified',
  'shop.verified': 'Checked by a person',
  'shop.unverifiedBody':
    'Listings appear straight away and are marked unverified until somebody checks them. A directory that waited for a check nobody staffs would be a directory with nothing in it.',
  'shop.mine': 'Listed from this device',
  'shop.noAccount':
    'No account and no name. This device keeps a secret that lets it edit the listing later; the register keeps only a digest of it, which proves you can edit this shop and says nothing about who you are.',
  'shop.report': 'Report this listing',
  'shop.reported': 'Reported. A person will look at it.',
  'shop.map': 'On the map',
  'shop.category.grocery': 'Grocery',
  'shop.category.produce': 'Fruit and vegetables',
  'shop.category.hardware': 'Hardware',
  'shop.category.clothing': 'Clothing',
  'shop.category.repair': 'Repairs',
  'shop.category.food': 'Food',
  'shop.category.medical': 'Medical',
  'shop.category.services': 'Services',
  'shop.category.other': 'Other',

  'pmap.title': 'The public map',
  'pmap.layers': 'Layers',
  'pmap.layer.stores': 'Shops',
  'pmap.layer.works': 'Roadworks',
  'pmap.empty': 'Nothing is listed on this map yet.',
